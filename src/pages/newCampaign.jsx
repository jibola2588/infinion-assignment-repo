              ...
              <div className="space-y-1">
                ...
                <div className="border border-[#999999] rounded-md p-[10px] w-full bg-transparent">
                  ...
                  <div className="flex gap-1 items-center flex-wrap">
                    {linkedArray.length >= 1 &&
                      linkedArray.map((item, i) => (
                        <div
                          className="w-[100px] break-words py-[5px] px-[10px] flex items-center justify-between rounded-md bg-primary text-white cursor-pointer"
                          key={i}
                        >
                          <span className="font-[nunito] font-medium text-[10px] leading-[14px]">
                            {item}
                          </span>
                          <MdOutlineClose
